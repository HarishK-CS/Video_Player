...
import com.techcos.videoPlayer.databinding.ActivityMainBinding
import com.techcos.videoPlayer.databinding.ThemeViewBinding
...
//        }
        binding.playOnline.setOnClickListener{
            startActivity(Intent(this@MainActivity, UrlActivity::class.java))
        }

        binding.playYoutube.setOnClickListener {
            if (checkForInternet(this)) {
                val url = "https://youtube.com/"
                val builder = CustomTabsIntent.Builder()
                @Suppress("DEPRECATION")
        ...
        binding.getThemes.setOnClickListener{
            val customDialog =
                LayoutInflater.from(this).inflate(R.layout.theme_view, binding.root, false)
            val bindingTV = ThemeViewBinding.bind(customDialog)
            val dialog = MaterialAlertDialogBuilder(this).setView(customDialog)
        ...
        binding.selectSortOrder.setOnClickListener {
            val menuItems = arrayOf(
                "Latest",
                "Oldest",
                "Name(A to Z)",
...
//                ActivityCompat.requestPermissions(this, arrayOf(READ_EXTERNAL_STORAGE),14)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.aboutNav -> startActivity(Intent(this, AboutActivity::class.java))
            R.id.exitNav -> exitProcess(1)
            R.id.main_rateus_option -> startActivity(
                Intent(
            ...
            R.id.main_more_apps_option -> startActivity(
                Intent(
                    Intent.ACTION_VIEW,
                    Uri.parse("https://play.google.com/store/apps/dev?id=5381883898197393897")
                )
            );
//            R.id.themesNav -> {
//                val customDialog =
